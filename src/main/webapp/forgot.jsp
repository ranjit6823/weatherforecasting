...
<div class="form">
			<!--login form start-->
			<form class="forgot-form" action="forgotPassword" onsubmit="return validateForm()" method="post">
				<h2>FORGOT PASSWORD</h2>
				<div><%if(message!=null){%> <span style="color: red;font-size: large;font-weight: bold;"><%= message%><%}%> </span> </div><br><br>
				<input id="email" autocomplete="off" type="email" name="Email" value="" placeholder="Email" required>
				
				<button type="submit" name ="button">GENERATE OTP<a href="reset.jsp"></a></button><br></br>
